...
const Footer = () => {
    ...
    const footerLinks = {
        ...
        webtools: [
            { label: 'Thumbnail Analyzer', path: 'https://www.vtanalyzer.site', external: true },
            { label: 'YouTube SEO', path: 'http://ytseoking.vercel.app/', external: true },
        ...
        <footer className="bg-gray-900 text-white">
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    {/* Other Links */}
                    <div>
                        <h3 className="font-bold text-lg mb-4">Our Web Tools</h3>
                        <ul className="space-y-2">
                            {footerLinks.webtools.map((link) => (
                                <li key={link.path}>
                                    <button
                                        onClick={() => router.push(link.path)}
                                        className="text-gray-400 hover:text-white transition-colors"
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400">
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <a href="tel:+917999742458" className="hover:text-white transition-colors">
                                    +91 79997 42458
                                </a>
                            </li>
                            <li className="flex items-start gap-2">
